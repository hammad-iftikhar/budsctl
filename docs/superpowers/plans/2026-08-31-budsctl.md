...
**Spec:** `docs/superpowers/specs/2026-08-31-budsctl.md` — read it before starting. Every protocol byte in this plan comes from §1 and the Appendix of that spec and was captured from a live device. Do not "improve" the protocol values.
...
docs/superpowers/
  specs/2026-08-31-budsctl.md                        The spec (already present)
